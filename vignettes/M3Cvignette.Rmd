...
![*Figure 2: PAC score for real data*](PACscore.png){width=95%}
...
![*Figure 4: Empirical p values*](pscore.png)
...
![*Figure 6: aheatmap of GBM consensus matrix *](aheatmapconsensusmatrix-vin2.png){width=95%}
